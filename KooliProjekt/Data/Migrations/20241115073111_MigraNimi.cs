...
{
    /// <inheritdoc />
    public partial class MigraNimi : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date = table.Column<DateTime>(type: "datetime2", maxLength: 55, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PanelProduction = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    montage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "WorkersMachines",
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Workers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Supervision = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CostOfMachines = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkersMachines", x => x.id);
                });
